...
/**
 * VAPTSECURE_Environment_Detector: Runtime Environment Detection Cascade
 * 
...
class VAPTSECURE_Environment_Detector
{
  private $cache_key = 'vaptsecure_environment_profile';
